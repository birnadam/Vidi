...
class MovieInfo extends Component {
  ...
  fetchMovie = () => {
    const urlMovie = fetch(
      ...
      }?api_key=dadbb348c7503427d5277348f42629dc&language=en-US`
    );
    const urlCredits = fetch(`https://api.themoviedb.org/3/movie/${
      this.props.match.params.movie_id
      }/credits?api_key=dadbb348c7503427d5277348f42629dc
        `);
    const urlVideos = fetch(`https://api.themoviedb.org/3/movie/${
      this.props.match.params.movie_id
      }/videos?api_key=dadbb348c7503427d5277348f42629dc
          `);
    ...
    return (
      <div id="movieInfoContainer">
        <div id="movies" className="pageMovie">
          ...
          <div className="movies-body scroll-hijack"></div>
...
export default requireAuth(connect(mapStateToProps, { updateCurrentPage })(MovieInfo));